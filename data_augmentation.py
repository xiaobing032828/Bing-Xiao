...
def evaluate_model(model, dataloader, device):
    ...
    with torch.no_grad():
        for inputs, labels in dataloader:
            ...
            all_preds.extend(preds.cpu().numpy()) #numpy不支持GPU
    ...
    print(f"Validation time: {train_time:.2f} seconds")
...
def main():
    ...
    print("Data augmentation of Resnet18 well done")
    ...
    torch.save(model.state_dict(), 'model-resnet18.pth') # 保存模型
    print("Test model of resnet18 saved successfully.")
